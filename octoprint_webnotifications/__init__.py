...
class WebnotificationsPlugin(octoprint.plugin.SettingsPlugin,
	...
	def get_assets(self):
		...
		return dict(
			...
			css=["css/webnotifications.css"],
			less=["less/webnotifications.less"]
		)
	...
	def get_update_information(self):
		...
		return dict(
			webnotifications=dict(
				displayName="Webnotifications Plugin",
...
__plugin_name__ = "Webnotifications Plugin"
